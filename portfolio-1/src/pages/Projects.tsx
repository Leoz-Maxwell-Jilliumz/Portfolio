...
function Projects() {
    return(
        <div className="bg-transparent min-h-screen w-full flex flex-col justify-start items-center m-0 p-0 mb-10 gap-8 md:gap-12 px-2 md:px-0">
            ...
            <div className="w-full flex flex-col items-center m-0 p-0">
                <ul className="text-white text-lg md:text-2xl w-full flex flex-col items-center gap-6 md:gap-8">
                    <li className="flex flex-col md:flex-row items-center gap-4 md:gap-8 w-full max-w-4xl bg-black/30 rounded-lg p-4 md:p-6">
